...
export const translations: Record<Language, any> = {
  en: {
    ...
    about: {
      ...
      founder_p1: 'PHALLBUN was born from a very personal memory.',
      founder_p2: 'I remember a moment with my mother that stayed in my heart. One day, she asked me to buy her a beautiful face cream. When I gave it to her, I saw her happiness — not only because of the cream, but because she believed it would help her feel beautiful.',
      founder_belief: 'That belief touched me deeply.',
      founder_p3: 'I realized that skincare is not only about formulas. It is about trust, emotion, and self-love. A small jar of cream can carry hope, confidence, and happiness.',
      founder_p4: 'This moment inspired me to focus on creating high-quality skincare — products made with care, honesty, and respect — for all the people I love: my family, my friends, and my customers.',
  ...
  fr: {
    ...
    about: {
      ...
      founder_p1: 'PHALLBUN est né d\'un souvenir très personnel.',
      founder_p2: 'Je me souviens d\'un moment avec ma mère qui est resté dans mon cœur. Un jour, elle m\'a demandé de lui acheter une belle crème pour le visage. En lui offrant, j\'ai vu son bonheur — pas seulement pour la crème, mais parce qu\'elle croyait qu\'elle l\'aiderait à se sentir belle.',
      founder_belief: 'Cette croyance m\'a profondément touchée.',
      founder_p3: 'J\'ai réalisé que les soins de la peau ne sont pas seulement des formules. C\'est une question de confiance, d\'émotion et d\'amour de soi.',
      founder_p4: 'Ce moment m\'a inspiré à créer des soins de haute qualité — des produits faits avec soin, honnêteté et respect.',
  ...
  it: {
    ...
    about: {
      ...
      founder_p1: 'PHALLBUN è nata da un ricordo molto personale.',
      founder_p2: 'Ricordo un momento con mia madre che mi è rimasto nel cuore. Un giorno mi chiese di comprarle una bella crema per il viso. Quando gliela diedi, vidi la sua felicità — non solo per la crema, ma perché credeva che l\'avrebbe aiutata a sentirsi bella.',
      founder_belief: 'Quella convinzione mi ha toccato profondamente.',
      founder_p3: 'Ho capito che la skincare non riguarda solo le formule. Riguarda la fiducia, l\'emozione e l\'amor proprio.',
      founder_p4: 'Questo momento mi ha ispirato a concentrarmi sulla creazione di skincare di alta qualità — prodotti realizzati con cura, onestà e rispetto.',
  ...
  de: {
    ...
    about: {
      ...
      founder_p1: 'PHALLBUN entstand aus einer sehr persönlichen Erinnerung.',
      founder_p2: 'Ich erinnere mich an einen Moment mit meiner Mutter. Eines Tages bat sie mich, ihr eine schöne Gesichtscreme zu kaufen. Als ich sie ihr gab, sah ich ihr Glück — nicht nur wegen der Creme, sondern weil sie glaubte, dass sie ihr helfen würde, sich schön zu fühlen.',
      founder_belief: 'Dieser Glaube hat mich tief berührt.',
      founder_p3: 'Mir wurde klar, dass es bei Hautpflege nicht nur um Formeln geht. Es geht um Vertrauen, Emotionen und Selbstliebe.',
      founder_p4: 'Dieser Moment inspirierte mich dazu, hochwertige Hautpflege zu kreieren — Produkte, die mit Sorgfalt, Ehrlichkeit und Respekt hergestellt werden.',
